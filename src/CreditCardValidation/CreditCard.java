...
public class CreditCard {
    ...
    public static boolean isValidNumberForMasterCard(String digits) {
    ...
    public static boolean isValidNumberForAmericanExpressCard(String digits)  {
        for (int i = 0; i < digits.length(); i++) {
    ...
    public static boolean isValidNumberForDiscoveryCard(String digits) {
        for (int i = 0; i < digits.length(); i++) {
    ...
    public static boolean isValidNumberForVisaCard(String digits) {
        for(int i = 0; i < digits.length(); i++) {
